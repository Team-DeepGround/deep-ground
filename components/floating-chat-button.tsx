      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative">
          ...
          {!isOpen && unreadCount > 0 && !isLoading && (
            <div className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center min-w-[24px] shadow-lg border-2 border-white z-10">
